...
const MasonryGridExample = () => {
  ...
  const fetchData = () => {
    ...
    const imageUrls = [
      ...
      'https://res.cloudinary.com/dzvttwdye/image/upload/v1743295994/Screenshot_2025-03-29_190345_gk19da.png',
      'https://res.cloudinary.com/dzvttwdye/image/upload/v1743302988/download_2_ilkhu1.png',
      'https://res.cloudinary.com/dzvttwdye/image/upload/v1743303850/download_d9zxel.png',
